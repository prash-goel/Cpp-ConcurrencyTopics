 ...
 * (i.e. the memory location) has not changed. This happens due to shallow copy that the default copy constructor does.
 * To resolve this issue, we have to make a custom copy constructor that does deep copy.
 * Note that when the delay is removed in the thread function,
